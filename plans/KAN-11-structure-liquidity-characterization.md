...
| 2026-07-18 | Initial publication | Commit `0273ea795e91693dd693cabb2478bfe159efaaf4` pushed; draft PR #28 opened with the required title. Push run `29656265631` and pull-request run `29656313198` passed. |
| 2026-07-18 | PR #28 temporal contract review | Tightened `EventObservation` so confirmation cannot precede observation and eligible timestamps cannot precede either observation or confirmation. `INELIGIBLE` still requires a null eligible timestamp. |
| 2026-07-18 | Focused negative contract tests | Passed: 5 tests proving rejection of confirmation-before-observation, eligibility-before-observation, eligibility-before-confirmation, and non-null ineligible timestamps; all generated events validate. |
| 2026-07-18 | Review-fix artifact regeneration | Passed: two no-op generator runs and `--check`; artifact remained byte-identical at SHA-256 `24393818414c659e33182d5cb929f50f11f96bf97dd29325c4615f72d6b554bd`. |
| 2026-07-18 | Review-fix focused KAN-11 suite | Passed: 33 tests in 4.71 seconds. |
| 2026-07-18 | Review-fix ordinary suite | Passed: 153 tests, 1 research test deselected, 10.89 seconds. |
